...
function index(req, res) {
  return _user2.default.find({}, '-salt -password').populate('characters', '').exec().then(function (users) {
...
function show(req, res, next) {
  ...
  return _user2.default.findById(userId).populate('characters', '').exec().then(function (user) {
    if (!user) {
...
function me(req, res, next) {
  ...
  return _user2.default.findOne({ _id: userId }, '-salt -password').populate('characters', '').exec().then(function (user) {
